...
def reload():
	try:
		...
		global dttarget, wdchanges, wd, losers, winners, lts, bears, bulls, ftx, mids, precisions
				...
				for lt in winners[bullbear]:
					...
					if winners[bullbear][lt] > threshold:
						if lt not in obj:
							...
							#sleep(10)
					if lt in obj:
						if obj[lt]['usdValue'] > 1 and winners[bullbear][lt] < threshold / 10 * 5:
